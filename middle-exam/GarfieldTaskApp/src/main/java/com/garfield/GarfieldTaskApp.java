...
import com.garfield.commands.exporter.ExportCommand;
import com.garfield.commands.task.AddTaskCommand;
import com.garfield.commands.task.DoneTaskCommand;
import com.garfield.commands.task.ListTaskCommand;
import com.garfield.commands.task.RemoveTaskCommand;
import com.garfield.commands.timer.TimeCommand;
...
public class GarfieldTaskApp {
    ...
    public static void main(String[] args) {
        ...
        cmd.addSubcommand("add", new AddTaskCommand(mainCommand.getRepository()));
        cmd.addSubcommand("list", new ListTaskCommand(mainCommand.getRepository()));
        cmd.addSubcommand("done", new DoneTaskCommand(mainCommand.getRepository()));
        cmd.addSubcommand("remove", new RemoveTaskCommand(mainCommand.getRepository()));
        cmd.addSubcommand("export", new ExportCommand(mainCommand.getRepository(), mainCommand.getExporter()));
        cmd.addSubcommand("timer", new TimeCommand(mainCommand.getTimer()));
